...
function Navbar(props) {
  return (
    <>
      <div className="flex w-full h-16 items-center justify-between bg-bms-800 z-40 place-content-start">
        <div className="container mx-auto flex justify-between items-center">
            ...
            <div className="w-7/12">
              <div className="w-full px-3">
                <form className="relative w-full">
                  <i className="absolute text-gray-400 top-2 left-2">
                    <IoIosSearch />
                  </i>
                  <input
                    type="text"
                    className="bg-white h-8 w-full rounded-sm focus:outline-none hover:cursor-pointer px-8 text-xs font-semibold"
                    name=""
          ...
          <div className="flex justify-evenly w-36 items-center">
            <div className="p-2">
              <button className="text-white bg-bms-50 text-xs h-6 w-16 rounded-md hover:bg-white hover:text-bms-50">
                {" "}
                Sign In
              </button>
            </div>
            ...
            <div className="relative inline-block text-left p-2">
              <div>
                <button
                  type="button"
                  className="inline-flex justify-center w-full rounded-md py-2 text-sm font-medium text-white"
                  id="menu-button"
                  aria-expanded="true"
                  aria-haspopup="true"
                >
      ...
      <div className="flex justify-between items-center text-bms-300 bg-bms-900 h-8 text-xs font-semibold ">
        <div className="container flex justify-between items-center mx-auto">
          <div className="flex justify-items-start items-center w-8/12">
            <nav className="flex justify-between w-6/12 ">
              ...
              <a href="/" className="relative">
                Streams
                <div className="text-rose-600 absolute bottom-2 right-0 mr-[-.5rem] text-[8px]">
                  NEW
                </div>
              </a>
              <a href="/">Events</a>
          ...
          <div className="flex justify-end items-center w-4/12">
            <nav className="flex justify-between w-10/12">
              <a href="/" className="relative">
                ListYourShows{" "}
                <div className="text-rose-600 absolute bottom-2 right-0 mr-[-.5rem] text-[8px]">
                  NEW
